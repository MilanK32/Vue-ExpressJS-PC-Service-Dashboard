        ...
        <nav class="bg-gray-800">
            <div class="mx-auto px-2 sm:px-6 lg:px-8">
                <div class="relative flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center justify-between md:w-3/4">
                        ...
                        <div class="ml-3 relative">
                            <div>
                                <button type="button"
                                    ...
                                    id="user-menu-button" aria-expanded="false" aria-haspopup="true" @click="openUserMenu = !openUserMenu">
